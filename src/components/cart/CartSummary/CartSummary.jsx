...
const CartSummary = ({
    ...
    return (
        <div className="bg-white border border-neutral-100 rounded-2xl p-6 shadow-sm space-y-4">
            <h3 className="font-serif text-sm font-bold text-brand-charcoal pb-3 border-b border-neutral-100">
                Order Summary
            </h3>
            ...
            <div className="space-y-3 text-xs text-neutral-500 font-medium">
                ...
                <div className="pt-3 border-t border-neutral-100 flex justify-between items-baseline font-bold text-brand-charcoal">
            ...
            <button
                ...
                className="w-full bg-brand-charcoal hover:bg-neutral-800 text-[#FAF6F0] font-bold text-xs uppercase tracking-[0.15em] py-3.5 rounded-xl flex items-center justify-center gap-2 mt-2 shadow-md hover:shadow-lg transition-all"
            >
            ...
            <div className="flex items-center justify-center gap-1.5 text-[10px] text-neutral-400 text-center pt-2">
                ...
                <span>Secure payment. Fully responsive mock checkout box.</span>
            </div>
        </div>
    );
};

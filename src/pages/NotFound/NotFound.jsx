...
const NotFound = () => {
  ...
  >
        <div className="w-16 h-16 bg-brand-beige rounded-full flex items-center justify-center text-brand-gold mx-auto shadow-inner">
          <Compass className="w-6 h-6 animate-spin-slow text-brand-gold-dark" />
        </div>
    ...
    className="bg-brand-charcoal hover:bg-neutral-800 text-white font-bold text-xs uppercase tracking-wider px-6 py-3 rounded-xl transition-colors inline-block"
  >
          Return to Home
        </button>
      </motion.div>
